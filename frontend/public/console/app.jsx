...
function ConsoleApp() {
  ...
  const handleLaunch = async (agent, channel, to, { agenda, prompt, voiceMode }) => {
    ...
    const body = {
      ...
      stt_model:    agent.stt_model    || 'nova-3',
      llm_provider: agent.llm_provider || 'Anthropic',
      llm_model:    agent.llm_model    || 'claude-haiku-4-5-20251001',
      tts_provider: agent.tts_provider || 'Deepgram Aura',
      tts_model:    agent.tts_model    || 'aura-2-asteria-en',
      vad_algo:     agent.vad_algo     || 'local_vad',
